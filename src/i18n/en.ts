export const en = {
  ...
  favourites: {
    ...
    searchPlaceholder: "Search your favourites...",
    empty: "You haven't favourited any stories yet.",
    emptyHint: "Tap the heart on any story to save it here.",
    removed: "Removed from favourites.",
    noResults: "No favourites match your search.",
  ...
  notifications: {
    ...
    confirmDeleteMessage: "Delete this notification? This cannot be undone.",
    unreadCount: "unread",
  },
  profile: {
    title: "Profile",
    ...
    sessionsRevokeAll: "Revoke all other sessions",
    sessionsRevokeAllHint: "Sign out every other device.",
    sessionsConfirmTitle: "Revoke this session?",
    sessionsConfirmMessage: "The device will be signed out immediately.",
    sessionsConfirmAllTitle: "Revoke all other sessions?",
    ...
    otherSessionsRevoked: "All other sessions revoked.",
  ...
  admin: {
    ...
    confirmRevokeSessions:
      "Revoke all other active sessions? Users signed into those sessions will be signed out.",
  ...
  share: {
    ...
    confirmRevoke:
      "Remove this user's access? They will no longer be able to open this story.",
  },
  storyOptions: {
    title: "Story Options",
    subtitle:
      "Browse the genres, eras, and civilizations available when creating stories.",
    genres: "Genres",
    eras: "Eras",
    ...
    editEra: "Edit era",
    editCivilization: "Edit civilization",
    optionName: "Display name",
    optionDescription: "Description",
    legacyHint:
      "Legacy enum value this option replaces (e.g. FANTASY). Leave empty for a new option.",
    createAction: "Create",
